package br.com.algamoney.api.repository.query.impl;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery{
	...
	private Long  total(LancamentoFilterDTO lancamentoFilter) {
	...
	private Predicate[] criarRestricoes(LancamentoFilterDTO lancamentoFilter, CriteriaBuilder cb,
	...
	//Exemplo com specification
	public Specification<Lancamento> filtrarComSpecification(LancamentoFilterDTO lancamentoFilter){
